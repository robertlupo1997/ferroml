...
> **Recommended: Use Playwright MCP** for direct browser control without writing scripts.
> Install: `claude mcp add playwright -- npx @playwright/mcp@latest`
> Use this skill only when MCP is unavailable or you need complex custom automation logic.
